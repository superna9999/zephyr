...
#define REGION_FLASH_ATTR(size) REGION_FLASH_PERM_ATTR(RO)
#define REGION_FLASH_PERM_ATTR(size, perm) \
		(NORMAL_OUTER_INNER_NON_CACHEABLE_NON_SHAREABLE | size | perm)
